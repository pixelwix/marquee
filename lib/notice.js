...
// next scheduled run (up to ~12h away) — Kometa still owns creating/removing
// the collection on post/clear, but the poster people actually see updates
// the moment the notice is saved.
