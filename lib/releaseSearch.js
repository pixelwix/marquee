...
function mapReleases(releases, limit = 40) {
  return [...releases]
    ...
    .map(r => ({
      ...
      // Only meaningful for a Sonarr season-level search (mixes per-episode
      // and whole-season releases in one result list) — always false/absent
      // for Radarr and for a single-episode Sonarr search.
