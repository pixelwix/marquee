...
- [x] Header button (desktop) + mobile FAB (opposite the request FAB) to
      report an issue on *any* library item, not just something recently
      watched — searches the actual Plex library and drills show -> season
